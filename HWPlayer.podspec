...
Pod::Spec.new do |s|
  s.name             = 'HWPlayer'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HWPlayer.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wozaizhelishua/HWPlayer'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wozaizhelishua' => 'kingboy941520@126.com' }
  s.source           = { :git => 'https://github.com/wozaizhelishua/HWPlayer.git', :tag => s.version.to_s }
